...
export const USERS: Record<string, User> = {
  ...
  'D002':  { id:'D002',  name:'S. Martinez',  role:'DETAILER',        rateCommunity:'IT',  email:'s.martinez@navy.mil' },
  'D003':  { id:'D003',  name:'R. Chen',      role:'DETAILER',        rateCommunity:'LS',  email:'r.chen@navy.mil' },
  'Q001':  { id:'Q001',  name:'M. Torres',    role:'QA_REVIEWER',     rateCommunity:'ALL', email:'m.torres@navy.mil' },
  'P001':  { id:'P001',  name:'K. Brooks',    role:'PLACEMENT_COORD', rateCommunity:'IT',  email:'k.brooks@navy.mil' },
  'PM01':  { id:'PM01',  name:'C. Miller',    role:'PROGRAM_MANAGER', rateCommunity:'IT',  email:'c.miller@navy.mil' },
  'L001':  { id:'L001',  name:'CAPT Rhodes',  role:'LEADERSHIP',      rateCommunity:'ALL', email:'j.rhodes@navy.mil' },
  'M001':  { id:'M001',  name:'Dr. Simmons',  role:'MEDICAL_REVIEWER',rateCommunity:'ALL', email:'b.simmons@navy.mil' },
